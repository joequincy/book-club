...
RSpec.describe 'book: show page has statistics', type: :feature do
  before(:each) do
  ...
  it 'displays top three reviews by rating' do
    ...
    expected_order = [
      ...
      review_list.index('Milly Dunlap')
    ]
    ...
    within '#top-reviews' do
      ...
      expect(page).to have_content(@review_18.title)
      expect(page).to have_content("Rating: #{@review_18.rating}")
  ...
  it 'displays bottom three reviews by rating' do
    ...
    within '#bottom-reviews' do
      ...
      expect(page).to have_content("Rating: #{@review_20.rating}")
  ...
  it 'displays average rating of all reviews for a book' do
    visit book_path(@book_6)
